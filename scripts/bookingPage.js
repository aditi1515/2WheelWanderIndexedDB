...
function isValidDateFormat(dateString) {
  // Regular expression to match the specified format: yyyy-MM-ddThh:mm
...
function filterOptionSearchParams() {
  ...
  if (
    !isValidDateFormat(startDateTime) ||
    !isValidDateFormat(endDateTime) ||
    !startDateTime ||
    !endDateTime ||
    startDateTimeInFormat < currentDate
  ) {
    redirection = true;
